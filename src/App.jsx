        ...
        <Card>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 space-y-2">
              ...
              <Input label={L('profile_city_label', 'ჩაწერე ქალაქი')} value={rep.city} onChange={upd('city')} placeholder={L('profile_city_placeholder', 'ქალაქი')} small required hasError={validationAttempted && !(rep.city || '').trim()} />
            </div>
          </div>
          <div className="mt-4">
